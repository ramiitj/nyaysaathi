...
export interface LanguageConfig {
  ...
  ui: {
    ...
    admin: string;
    startFresh: string;
    startFreshConfirmTitle: string;
    startFreshConfirmDesc: string;
    startFreshConfirmYes: string;
    startFreshConfirmNo: string;
    helpline: string;
    attach: string;
    voice: string;
    text: string;
...
export const LANGUAGES: Record<LanguageCode, LanguageConfig> = {
  HI: {
    ...
    ui: {
      ...
      startFreshConfirmTitle: 'नया शुरू करें?',
      startFreshConfirmDesc: 'यह आपकी वर्तमान बातचीत और अपलोड की गई फाइलें साफ कर देगा। क्या आप वाकई जारी रखना चाहते हैं?',
      startFreshConfirmYes: 'हाँ, नया शुरू करें',
      startFreshConfirmNo: 'रद्द करें',
      helpline: 'हेल्पलाइन',
      attach: 'संलग्न करें',
      voice: 'आवाज़',
      text: 'टेक्स्ट',
  ...
  EN: {
    ...
    ui: {
      ...
      startFreshConfirmDesc: 'This will clear your current conversation and uploaded files. Are you sure you want to continue?',
      startFreshConfirmYes: 'Yes, Start Fresh',
      startFreshConfirmNo: 'Cancel',
      helpline: 'Helpline',
      attach: 'Attach',
      voice: 'Voice',
      text: 'Text',
  ...
  BN: {
    ...
    ui: {
      ...
      startFreshConfirmTitle: 'নতুন শুরু করবেন?',
      startFreshConfirmDesc: 'এটি আপনার বর্তমান কথোপকথন এবং আপলোড করা ফাইলগুলি মুছে ফেলবে। আপনি কি নিশ্চিত যে আপনি চালিয়ে যেতে চান?',
      startFreshConfirmYes: 'হ্যাঁ, নতুন শুরু করুন',
      startFreshConfirmNo: 'বাতিল করুন',
      helpline: 'হেল্পলাইন',
      attach: 'সংযুক্ত করুন',
      voice: 'ভয়েস',
      text: 'টেক্সট',
  ...
  TA: {
    ...
    ui: {
      ...
      startFreshConfirmTitle: 'புதிதாக தொடங்கவா?',
      startFreshConfirmDesc: 'இது உங்கள் தற்போதைய உரையாடலையும் பதிவேற்றிய கோப்புகளையும் அழிக்கும். தொடர விரும்புகிறீர்களா?',
      startFreshConfirmYes: 'ஆம், புதிதாக தொடங்கு',
      startFreshConfirmNo: 'ரத்து செய்',
      helpline: 'உதவி எண்',
      attach: 'இணைக்கவும்',
      voice: 'குரல்',
      text: 'உரை',
  ...
  TE: {
    ...
    ui: {
      ...
      startFreshConfirmTitle: 'కొత్తగా ప్రారంభించాలా?',
      startFreshConfirmDesc: 'ఇది మీ ప్రస్తుత సంభాషణ మరియు అప్‌లోడ్ చేసిన ఫైల్‌లను తొలగిస్తుంది. మీరు కొనసాగించాలనుకుంటున్నారా?',
      startFreshConfirmYes: 'అవును, కొత్తగా ప్రారంభించు',
      startFreshConfirmNo: 'రద్దు',
  ...
  MR: {
    ...
    ui: {
      ...
      startFreshConfirmTitle: 'नव्याने सुरू करायचे?',
      startFreshConfirmDesc: 'हे तुमचे सध्याचे संभाषण आणि अपलोड केलेल्या फाइल्स साफ करेल. तुम्हाला खात्री आहे का?',
      startFreshConfirmYes: 'हो, नव्याने सुरू करा',
      startFreshConfirmNo: 'रद्द करा',
      helpline: 'हेल्पलाइन',
      attach: 'जोडा',
      voice: 'आवाज',
      text: 'मजकूर',
  ...
  GU: {
    ...
    ui: {
      ...
      startFreshConfirmTitle: 'નવેસરથી શરૂ કરવું છે?',
      startFreshConfirmDesc: 'આ તમારી વર્તમાન વાતચીત અને અપલોડ કરેલી ફાઇલો સાફ કરશે. શું તમે ખાતરી કરો છો?',
      startFreshConfirmYes: 'હા, નવેસરથી શરૂ કરો',
      startFreshConfirmNo: 'રદ કરો',
      helpline: 'હેલ્પલાઇન',
      attach: 'જોડો',
      voice: 'અવાજ',
      text: 'ટેક્સ્ટ',
  ...
  KN: {
    ...
    ui: {
      ...
      startFreshConfirmTitle: 'ಹೊಸದಾಗಿ ಪ್ರಾರಂಭಿಸಬೇಕೆ?',
      startFreshConfirmDesc: 'ಇದು ನಿಮ್ಮ ಪ್ರಸ್ತುತ ಸಂಭಾಷಣೆ ಮತ್ತು ಅಪ್‌ಲೋಡ್ ಮಾಡಿದ ಫೈಲ್‌ಗಳನ್ನು ತೆರವುಗೊಳಿಸುತ್ತದೆ. ಮುಂದುವರಿಸಲು ನಿಮಗೆ ಖಚಿತವೇ?',
      startFreshConfirmYes: 'ಹೌದು, ಹೊಸದಾಗಿ ಪ್ರಾರಂಭಿಸಿ',
      startFreshConfirmNo: 'ರದ್ದುಮಾಡಿ',
  ...
  ML: {
    ...
    ui: {
      ...
      startFreshConfirmTitle: 'പുതുതായി തുടങ്ങണോ?',
      startFreshConfirmDesc: 'ഇത് നിങ്ങളുടെ നിലവിലെ സംഭാഷണവും അപ്‌ലോഡ് ചെയ്ത ഫയലുകളും മായ്ക്കും. തുടരാൻ നിങ്ങൾക്ക് ഉറപ്പാണോ?',
      startFreshConfirmYes: 'അതെ, പുതുതായി തുടങ്ങുക',
      startFreshConfirmNo: 'റദ്ദാക്കുക',
  ...
  PA: {
    ...
    ui: {
      ...
      startFreshConfirmTitle: 'ਨਵੇਂ ਸਿਰੇ ਤੋਂ ਸ਼ੁਰੂ ਕਰਨਾ ਹੈ?',
      startFreshConfirmDesc: 'ਇਹ ਤੁਹਾਡੀ ਮੌਜੂਦਾ ਗੱਲਬਾਤ ਅਤੇ ਅੱਪਲੋਡ ਕੀਤੀਆਂ ਫਾਈਲਾਂ ਨੂੰ ਸਾਫ਼ ਕਰ ਦੇਵੇਗਾ। ਕੀ ਤੁਸੀਂ ਜਾਰੀ ਰੱਖਣਾ ਚਾਹੁੰਦੇ ਹੋ?',
      startFreshConfirmYes: 'ਹਾਂ, ਨਵੇਂ ਸਿਰੇ ਤੋਂ ਸ਼ੁਰੂ ਕਰੋ',
      startFreshConfirmNo: 'ਰੱਦ ਕਰੋ',
      helpline: 'ਹੈਲਪਲਾਈਨ',
      attach: 'ਜੋੜੋ',
      voice: 'ਆਵਾਜ਼',
      text: 'ਟੈਕਸਟ',
  ...
  OR: {
    ...
    ui: {
      ...
      startFreshConfirmTitle: 'ନୂଆରୁ ଆରମ୍ଭ କରିବେ?',
      startFreshConfirmDesc: 'ଏହା ଆପଣଙ୍କ ବର୍ତ୍ତମାନର କଥୋପକଥନ ଏବଂ ଅପଲୋଡ୍ ହୋଇଥିବା ଫାଇଲ୍ ସଫା କରିଦେବ। ଆପଣ ନିଶ୍ଚିତ କି?',
      startFreshConfirmYes: 'ହଁ, ନୂଆରୁ ଆରମ୍ଭ କରନ୍ତୁ',
      startFreshConfirmNo: 'ବାତିଲ କରନ୍ତୁ',
      helpline: 'ହେଲ୍ପଲାଇନ୍',
  ...
  UR: {
    ...
    ui: {
      ...
      startFreshConfirmTitle: 'نئے سرے سے شروع کریں؟',
      startFreshConfirmDesc: 'یہ آپ کی موجودہ گفتگو اور اپلوڈ کی گئی فائلوں کو صاف کر دے گا۔ کیا آپ واقعی جاری رکھنا چاہتے ہیں؟',
      startFreshConfirmYes: 'ہاں، نئے سرے سے شروع کریں',
      startFreshConfirmNo: 'منسوخ کریں',
      helpline: 'ہیلپ لائن',
      attach: 'منسلک کریں',
      voice: 'آواز',
      text: 'ٹیکسٹ',
